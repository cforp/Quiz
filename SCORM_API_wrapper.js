    ...
    if(scorm.connection.isActive){
        ...
        if(API){
	 		...
	 		if(scorm.handleExitMode /*&& !exitStatus*/){
				...
				if(completionStatus !== "completed" && completionStatus !== "passed" /*added condition from original wrapper -->*/ && completionStatus !== "failed" /*<--*/){
					//alert("not completed")
					switch(scorm.version){
...
pipwerks.SCORM.data.oldToNewScormIfApplicable = function(model){
	var converted = model;//if not found, will return same
	scorm = pipwerks.SCORM;
    if(scorm.connection.isActive){
        var API = scorm.API.getHandle(),
            errorCode = 0;
        if(API){
        	if(scorm.version == "1.2"){
        		...
        		switch(model){
        			...
        			case "cmi.core.lesson_status":
        				converted = "cmi.completion_status";
        				break;
        			...
        			case "cmi.core.lesson_location":
        				converted = "cmi.location";
        				break;
        				
        			case "cmi.core.score.raw":
        				converted = "cmi.score.raw";
        				break;
        			
        			case "cmi.core.score.min":
        				converted = "cmi.score.min";
        				break;
        			
        			case "cmi.core.score.max":
        				converted = "cmi.score.max";
        				break;
        			...
        			case "cmi.student_data.mastery_score" :
        				converted = "cmi.scaled_passing_score";
        				break;
        				
        			case "cmi.core.session_time" :
        				converted = "cmi.session_time";
        				break;
        		};
        	}
		}
...
pipwerks.SCORM.convert = pipwerks.SCORM.data.oldToNewScormIfApplicable;
// end of added
