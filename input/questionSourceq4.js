...
contentSlide1.formatArray[0].value = "<strong>Des conseils et des suggestions</strong>";
...
cm1.formatArray[0].value = "Lisez la question et choisissez <u>la</u> bonne réponse.<br />";
...
cm2.formatArray[0].value = "Lisez la question et choisissez <u>la</u> bonne réponse.<br />";
...
cm3.partialPoints = false;
               
cm3.formatArray[0] = new Array();
cm3.formatArray[0].css = "banner";
cm3.formatArray[0].type = "normal";
cm3.formatArray[0].value = "Lisez la question et choisissez <u>la</u> bonne réponse.<br />";
...
cm3.interactionArray.setting.nbColumn = 1;
...
MR.formatArray[0].value = "Cochez toutes  les bonnes réponses.<br />Qu'est-ce que  la <strong>sage-femme</strong> a le droit de faire?";
...
contentSlide2.formatArray[0].value = "<strong>Les tâches de la sage-femme</strong>";
...
contentSlide2.formatArray[2].value = '<p>La <strong>sage-femme</strong>&nbsp;peut  :</p><ul type="disc"><li>donner des <strong>soins prénataux</strong> et <strong>postnataux</strong>;</li><li>aider les femmes à <strong>accoucher</strong>;</li><li>donner des <strong>cours prénataux</strong>.</li></ul>';
...
tf1.formatArray[0].value = "Dites si l’affirmation est vraie ou fausse.<br />Rhianna veut <strong>accoucher</strong> à la maison. Elle  peut choisir un <strong>obstétricien</strong>.";
...
tf2.formatArray[0].value = "Dites si l’affirmation est vraie ou fausse.<br />Rhianna a choisi un <strong>obstétricien</strong>.  Est-ce lui qui va s'occuper de son <strong>suivi  postnatal</strong>?";
...
contentSlide3.formatArray[0].value = "L'exercice  est terminé.";
